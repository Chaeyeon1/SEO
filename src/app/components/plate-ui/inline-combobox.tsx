...
const InlineComboboxContent: typeof ComboboxPopover = ({
  ...
  return (
    <Portal>
      <ComboboxPopover
        className={cn(
          'z-[500] max-h-[288px] w-[300px] overflow-y-auto rounded-md bg-white shadow-md dark:bg-gray-950',
          className
        )}
        {...props}
      />
...
const comboboxItemVariants = cva(
  'relative flex h-9 select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none',
  {
    ...
    variants: {
      interactive: {
        false: '',
        true: 'cursor-pointer transition-colors hover:bg-gray-100 hover:text-gray-900 data-[active-item=true]:bg-gray-100 data-[active-item=true]:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:data-[active-item=true]:bg-gray-800 dark:data-[active-item=true]:text-gray-50',
      },
    },
  }
);
