              ...
              {isVideo ? (
                isYoutube ? (
                  <LiteYouTubeEmbed
                    ...
                    wrapperClass={cn(
                      'rounded-sm',
                      focused && selected && 'ring-2 ring-gray-950 ring-offset-2 dark:ring-gray-300',
              ...
              {isTweet && (
                <div
                  className={cn(
                    ...
                    !readOnly &&
                      selected &&
                      '[&_.react-tweet-theme]:ring-2 [&_.react-tweet-theme]:ring-gray-950 [&_.react-tweet-theme]:ring-offset-2 dark:[&_.react-tweet-theme]:ring-gray-300'
                  )}
                >
                  <Tweet id={embed!.id!} />
                </div>
