...
export function CommentLeaf({
  ...
  if (!state.isActive) {
    for (let i = 1; i < state.commentCount; i++) {
      aboveChildren = <span className='bg-gray-900/20 dark:bg-gray-50/20'>{aboveChildren}</span>;
    }
  }
  ...
  return (
    <PlateLeaf
      ...
      className={cn(
        ...
        state.isActive ? 'bg-gray-900/40 dark:bg-gray-50/40' : 'bg-gray-900/20 dark:bg-gray-50/20',
        className
      )}
      nodeProps={{
        ...rootProps,
